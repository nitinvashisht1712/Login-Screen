...
export default function LoginScreen3() {
      ...
      <View style={{ marginTop: 10 }}>
        ...
        <View style={styles.socialLoginView}>
          <TouchableOpacity style={styles.socialLoginTouchable}>
            <Icon name='google' type='font-awesome' color='#EF5455' />
          </TouchableOpacity>
          <TouchableOpacity style={styles.socialLoginTouchable}>
            <Icon name='facebook' type='font-awesome' color='#EF5455' />
          </TouchableOpacity>
          <TouchableOpacity style={styles.socialLoginTouchable}>
            <Icon name='apple' type='font-awesome' color='#EF5455' />
          </TouchableOpacity>
        </View>
      </View>
    );
  ...
  return (
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <LinearGradient colors={['#0D324D', '#7b4397']} style={styles.container}>
...
const styles = StyleSheet.create({
  ...
  buttonText: {  fontSize: 16, color: '#EF5455' },
  forgotPasswordText: {
    marginHorizontal: 20,
    marginTop: 20,
    alignSelf: 'flex-end',
